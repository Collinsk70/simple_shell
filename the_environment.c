...
/**
 * _getenv - Create environment variable.
 *
 * @name: Variable name for environment.
 *
 * Return: On success, the value of @name; NULL if failed.
 **/
...
/**
 * which - Locate the directory to be used.
 *
 * @filename: Variable declared.
 * @info: Arguments passed in the program.
 *
 * Return: Pointer to a string with the found path or NULL if failed.
 */
...
/**
 * is_current_path - Check the arrangement of a path.
 *
 * @path: Variable representing the path to be checked.
 * @info: Arguments passed in the program.
 *
...
/**
 * get_full_env - Get the environment.
 *
 * Return: No explicit return value (void).
 **/
